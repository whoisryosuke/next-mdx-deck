...
1. Clone project `git clone git@github.com:whoisryosuke/next-mdx-deck.git`
1. Navigate to project `cd next-mdx-deck`
...
> That's it. I'd say more if we had tests, a CI/CD setup, versioning, etc. But it's pretty casual right now. Make sure if you have working code to test the build process and ensure it doesn't fail.
